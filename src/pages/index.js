  ...
  render() {
    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <div className="flex flex-col-reverse sm:flex-row jusitfy-between items-center py-4">
          <div className="sm:w-2/5 flex flex-col items-center sm:items-start text-center sm:text-left">
            <h1 className="uppercase text-2xl sm:text-4xl text-gray-800 font-bold leading-none tracking-wide mb-2">
              #100DaysOfGatsby
            </h1>
            <h2 className="uppercase text-xl sm:text-2xl text-orange-500 text-secondary mb-6">
              Challenge
            </h2>
            <p className="text-gray-600 leading-relaxed mb-12">
              Welcome on my Page, currently this Site is heavily under
              development because I am a part of the <b>#100DaysOfGatsby </b>
              Challenge, and I will see how far I can get. So if you want to
              learn more about my journey, you can visit my Blog.
            </p>
            <Link
              to="/blog/"
              className="bg-teal-500 hover:bg-teal-600 px-3 py-3 rounded-lg text-base text-white font-semibold leading-tight shadow-md uppercase"
            >
              see my blog
            </Link>
          </div>
          <div className="mb-16 sm:mb-0 ml-4 mr-4 mt-8 sm:mt-0 sm:w-3/5 sm:pl-20">
            <svg
